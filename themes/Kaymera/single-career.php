                        ...
                        <div class="single-content-block">
                            ...
                            <div class="single-info-row">
                                <span class="single-info-desc">
                                    <svg class="icon">
                                        <use xlink:href="<?= get_template_directory_uri(); ?>/img/icons/svgmap.svg#clock" />
                                    </svg>    
                                    <span class="text">
                                        <?= get_the_date('j.n.Y'); ?>
                                    </span>
                    ...
                    <div class="col-4 col-md">
                        <div class="single-aside">
                            <div class="single-aside-top">
                                ...
                                <a href="<?php home_url(); ?>/careers/" class="mdc-button">
                            ...
                            <div class="single-aside-set">
                                <?php 
                                    while ( $query->have_posts() ) {
                                        $query->the_post();
                                        get_template_part('partials/loop-popular-career');
                                    }
                                    wp_reset_postdata();
                                ?>
                            </div>
